      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative flex-1">
          <input type="number" min={0} step={100} placeholder="0"
            ...
            className="w-full font-sans text-ink bg-paper-warm border border-paper-border rounded-sm px-3 py-1.5 pr-7 outline-none focus:border-accent-light transition-colors" />
          <span className="absolute right-2.5 top-1/2 -translate-y-1/2 font-sans text-[11px] text-ink-faint pointer-events-none">원</span>
        </div>
      </div>
      {/* 만족도 슬라이더 */}
      <div className="flex items-center gap-2">
        <span className="font-sans text-[11px] text-ink-faint w-14 flex-shrink-0">만족도</span>
        <div className="flex-1 flex items-center gap-2">
          ...
          <span className="font-sans text-[13px] text-accent w-8 text-right flex-shrink-0">
